...
You are fixing a GitHub issue for the gikiUK/admin repository.
...
Only create the worktree **after the plan is approved**. The issue number has been extracted above (works whether the argument was a full URL like `https://github.com/gikiUK/admin/issues/123` or just `123`).
