...
export function EmissionTargetsSection({ get, set, hint }: { get: FieldGetter; set: FieldSetter; hint: FieldHint }) {
  return (
    <SectionCard title="Emission Targets">
      ...
      <TextareaSection label="Long-term Target" description='e.g. "Net zero by 2050"' {...hint("target_longterm")}>
        <Input value={get("target_longterm")} onChange={(e) => set("target_longterm", e.target.value)} />
      </TextareaSection>
      <TextareaSection label="Baseline Year" description='e.g. "2023"' {...hint("baseline_year")}>
        <Input value={get("baseline_year")} onChange={(e) => set("baseline_year", e.target.value)} />
      </TextareaSection>
      <TextareaSection label="Baseline Emissions (tCO2e)" description='e.g. "1250"' {...hint("baseline_emissions")}>
