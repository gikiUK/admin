...
function PopoverContent({
  ...
  /**
   * Render the content inside a Portal (default). Set to `false` when the
   * popover lives inside a Radix Dialog/Sheet — portaling escapes the
   * dialog's react-remove-scroll subtree, which then swallows wheel events
   * on the popover (touchpad scroll fails).
   */
  portal?: boolean;
}) {
  const content = (
